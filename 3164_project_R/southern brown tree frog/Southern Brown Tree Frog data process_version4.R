...
cluster_table[cluster_table$`a$cluster`==1,29]='low reliability'
cluster_table[cluster_table$`a$cluster`==2,29]='high reliability'
...
write.csv(cluster_table, 'Southern Brown Tree Frog cluster.csv')
detach(data)
